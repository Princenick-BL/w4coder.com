...
export default function Slide({ article, style, type = 0, isBreakpoint = 1 }) {
  ...
  return (
    ...
    >
      <Link href={!isVideo ? `/articles/${article._id}/${article.slug}`:`https://www.youtube.com/watch/${article?.id?.videoId}`}>
        <div className={styles.slider}>
          ...
          {isVideo ? (
              ...
              src={`https://www.youtube.com/embed/${article?.id?.videoId}`}  frameborder="0"
