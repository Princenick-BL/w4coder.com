            ...
            <div className={styles.mobileSubHead} style={{display:"flex",justifyContent:"space-between",alignItems:"center"}}>
              <div className={styles.fhW}>
                <div className={styles.hW} onClick={(e)=>{setOpenedMenu(!openedMenu)}}>
                  {openedMenu ? (
                    <svg  className='hamburger' xmlns="http://www.w3.org/2000/svg" viewBox="0 1 20 20"><path fillRule="evenodd" clipRule="evenodd" d="M18.278 16.864a1 1 0 0 1-1.414 1.414l-4.829-4.828-4.828 4.828a1 1 0 0 1-1.414-1.414l4.828-4.829-4.828-4.828a1 1 0 0 1 1.414-1.414l4.829 4.828 4.828-4.828a1 1 0 1 1 1.414 1.414l-4.828 4.829 4.828 4.828z"></path></svg>
                  ):(
                    <svg className='hamburger' xmlns="http://www.w3.org/2000/svg" viewBox="0 1 20 20"><path fillRule="evenodd" d="M4 5h16a1 1 0 0 1 0 2H4a1 1 0 1 1 0-2zm0 6h16a1 1 0 0 1 0 2H4a1 1 0 0 1 0-2zm0 6h16a1 1 0 0 1 0 2H4a1 1 0 0 1 0-2z"></path></svg>
                  )}
                </div>
                <h2>W4CODER</h2>
              </div>
