...
export default function DefaultLayout({title,description,isBreakpoint,toggleTheme,page1,topA,stories,lang,children}) {
  return (
    <div className={styles.container}>
      ...
      <Header isBreakpoint={isBreakpoint} stories={stories}/>
